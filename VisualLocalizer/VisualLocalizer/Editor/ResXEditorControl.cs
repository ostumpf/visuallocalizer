    ...
    internal sealed class ResXEditorControl : TableLayoutPanel,IEditorControl {
        ...
        private void AddExistingResources(object sender, EventArgs e) {
            try {
                ...
                string[] files = VisualLocalizer.Library.Components.MessageBox.SelectFilesViaDlg("Select files", Path.GetDirectoryName(Editor.FileName),
        ...
        /// <param name="origin">The type of adding the files</param>
        ...
        private ListViewKeyItem AddExistingItem(AbstractListView list, ProjectItem folder, string file, Type type, FILES_ORIGIN origin) {
            ...
            if (localFileExists) { // file with same name already exists in the project
                if (fileSameAsLocalFile) { // it's the same file that is being added
                    ...
                    DialogResult result = VisualLocalizer.Library.Components.MessageBox.Show(string.Format("Item \"{0}\" already exists. Do you want to overwrite the file?", fileName), null, OLEMSGBUTTON.OLEMSGBUTTON_YESNO, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST, OLEMSGICON.OLEMSGICON_QUERY);
       ...
       /// <returns>Newly created list view item</returns>
        ...
        /// <param name="dataTabItems">List of available tabs</param>       
        ...
        /// <summary>
        /// Invokes the InlineRequested(inline and remove) event
        /// </summary>        
        ...
        private void MergeWithFile(bool deleteSource) {
            ...
            try {
                ...
                string[] files = VisualLocalizer.Library.Components.MessageBox.SelectFilesViaDlg("Select file", Path.GetDirectoryName(Editor.FileName),
                ...
                DialogResult result = VisualLocalizer.Library.Components.MessageBox.Show(string.Format("Do you really want to add all resources from \"{0}\" to this file?" + delSrcString, Path.GetFileName(file)), null, OLEMSGBUTTON.OLEMSGBUTTON_YESNO, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_THIRD, OLEMSGICON.OLEMSGICON_WARNING);
                if (result == DialogResult.No) return;                
