...
namespace VisualLocalizer.Components {
    ...
    internal sealed class CodeReferenceResultItem : AbstractResultItem {
        ...
        public string GetQuotedValue() {
            return "\"" + Value.ConvertUnescapeSequences() + "\"";
        }

        public override string ToString() {
            return string.Format("CodeReferenceResultItem: ReferenceText=\"{0}\", Value=\"{1}\", Source=\"{2}\", Target=\"{3}\"", FullReferenceText, Value, (SourceItem == null ? "(null)" : SourceItem.Name), (DestinationItem == null ? "(null)" : DestinationItem.InternalProjectItem.Name));
        }
    }
}
