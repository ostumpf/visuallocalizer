...
namespace VisualLocalizer.Library.Gui {
    ...
    public abstract class AbstractCheckedGridView<ItemType> : DataGridView where ItemType : class {
        ...
        /// <summary>
        /// Tooltip displayed over error icon
        /// </summary>
        protected ToolTip ErrorToolTip; 

        /// <summary>
        /// Header cell with a checkbox            
        /// </summary>
        protected DataGridViewCheckBoxHeaderCell CheckHeader; 
        
        /// <summary>
        /// Controls ErrorToolTip display
        /// </summary>
        protected Timer ErrorTimer; 

        /// <summary>
        /// True if the error tooltip is visible
        /// </summary>
        protected bool ErrorToolTipVisible;

        /// <summary>
        /// Background color of rows with error (red)
        /// </summary>
        protected Color ErrorColor = Color.FromArgb(255, 213, 213); 

        /// <summary>
        /// Background color of rows whose key is already in the resource file with the same value (ok - green)
        /// </summary>
        protected Color ExistingKeySameValueColor = Color.FromArgb(213, 255, 213); 

        /// <summary>
        /// Set of the rows which have an error text
        /// </summary>
        protected HashSet<DataGridViewRow> errorRows = new HashSet<DataGridViewRow>();

        /// <summary>
        /// Previously selected row - used when the context column is displayed to wrap its content
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractCheckedGridView{ItemType}"/> class.
        /// </summary>
